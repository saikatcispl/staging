...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">Add Membership Package to Sync from LimeLight CRM</h1>
<!-- END PAGE TITLE-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase">Add Membership Package</span>
                </div>                                       
            </div>
            <div class="portlet-body form">
                <div class="alert alert-danger" id="error_div" style="display:none;"></div>
                <form role="form" id="ll_product_add_form" method="post" action="{{ URL::to('admin/addMembershipPackageLL') }}">
                    {{ csrf_field() }}
                    <div class="form-body">
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.type == 'success') {
                        window.location.href = "{{ URL::to('admin/manageMembershipPackage') }}";
                    } else {
